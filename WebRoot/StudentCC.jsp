...
<head>
 <title>学生选课页面</title>
   <script src="js/jquery-3.5.0.min.js"></script>
    <script src="js/studentCC.js"></script>
...
<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				<a class="navbar-brand" href="login.html">Student Chose Classes</a>
			</div>			
			<div>
...
<div id="pageBody">
    ...
    <table>
        ...
        <tr>
            ...
            <th width="100" id="sortByUserName" data="SNO">教师号</th>
            <th width="120">教师用户名</th>
            <th width="100">课程号</th>
            <th width="100">课程名</th>
        </tr>
        </thead>
